...
@Component({
  selector: 'app-create-edit-return-stock',
  templateUrl: './create-edit-return-stock.component.html',
  styleUrls: ['./create-edit-return-stock.component.scss']
})
export class CreateEditReturnStockComponent extends PopupWindowBaseComponent implements OnInit, AfterViewInit, ICustomizeFormValidate {
