...
@Component({
  selector: 'app-output-stock-query',
  templateUrl: './output-stock-query.component.html',
  styleUrls: ['./output-stock-query.component.scss']
})
export class OutputStockQueryComponent implements OnInit, AfterViewInit, IQiezziCenterHeaderComponent {
...
// 筛选配置
  ...
  onControl(e) {
    /*if (e === 0) {
     this.application.frontLayer.openPopupWindow(CreateFeeComponent, '新增收费单', PopupWindowSize.LARGE, 600, {}, false)
     .subscribe(t => {
     console.log("刷新列表了");
     this.getBillList();
     });
