...
@Component({
  selector: 'app-output-stock',
  templateUrl: './output-stock.component.html',
  styleUrls: ['./output-stock.component.scss']
})
export class OutputStockComponent implements OnInit , AfterViewInit {
