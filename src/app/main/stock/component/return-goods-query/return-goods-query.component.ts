...
@Component({
  selector: 'app-return-goods-query',
  templateUrl: './return-goods-query.component.html',
  styleUrls: ['./return-goods-query.component.scss']
})
export class ReturnGoodsQueryComponent implements OnInit , AfterViewInit, IQiezziCenterHeaderComponent {
...
// 筛选配置
  ...
  onControl(e) {
    if (e === 0) {
      this.application.frontLayer.openPopupWindow(CreateEditReturnStockComponent, '新增退货单', PopupWindowSize.LARGE, 1100, {}, false)
        .subscribe(t => {
          console.log("刷新列表了");
          // this.getBillList();
        });
