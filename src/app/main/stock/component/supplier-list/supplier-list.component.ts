...
export class SupplierListComponent implements OnInit , AfterViewInit, IQiezziCenterHeaderComponent {
...
// 筛选配置
  ...
  onControl(e) {
    if (e === 0) {
      this.application.frontLayer.openPopupWindow(CreateEditSupplierComponent, '新增供应商', PopupWindowSize.MIDDLE, 530, {}, false)
        .subscribe(t => {
          // console.log("刷新列表了");
          // this.getBillList();
        });
  ...
  edit(e){
    console.log(111);
    this.application.frontLayer.openPopupWindow(CreateEditSupplierComponent, '新增供应商', PopupWindowSize.MIDDLE, 530, {}, false).subscribe(t => {
      // console.log("刷新列表了");
      // this.getBillList();
    });
    if (e === 0) {
