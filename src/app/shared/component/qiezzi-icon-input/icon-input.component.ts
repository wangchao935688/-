import {
  AfterViewInit, Component, ElementRef, EventEmitter, forwardRef, HostListener, Input, OnInit,
  Output
} from '@angular/core';
...
export class IconInputComponent implements OnInit, ControlValueAccessor, AfterViewInit {
